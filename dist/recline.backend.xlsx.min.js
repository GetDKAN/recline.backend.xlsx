...
!function(a){"use strict";a=a||{},a.Backend=a.Backend||{},a.Backend.XLS={};var b=a.Backend.XLS;b.__type__="xls";var c="undefined"!=typeof jQuery&&jQuery.Deferred||_.Deferred;b.fetch=function(a){var d=new c,e=new XMLHttpRequest;return e.open("GET",a.url,!0),e.responseType="arraybuffer",e.onload=function(){for(var c={},f=new Uint8Array(e.response),g=[],h=0;h!==f.length;++h)g[h]=String.fromCharCode(f[h]);var i=g.join(""),j=XLS.read(i,{type:"binary"}),k=a.sheet||_.first(_.keys(j.Sheets));c.fields=b.extractFields(j.Sheets[k]),c.useMemoryStore=!0,c.records=b.extractData(j.Sheets[k],c.fields),d.resolve(c)},e.send(),d.promise()},b.extractFields=function(a){var b,c=[],d=XLS.utils.decode_range(a["!ref"]),e=d.s.r;for(b=d.s.c;b<=d.e.c;++b){var f=a[XLS.utils.encode_cell({c:b,r:e})],g="UNKNOWN "+b;f&&f.t&&(g=XLS.utils.format_cell(f)),c.push(g)}return c},b.extractData=function(a,b){var c,d,e,f=[],g=XLS.utils.decode_range(a["!ref"]),h={};for(d=g.s.r+1;d<=g.e.r;++d){for(h={},c=g.s.c;c<=g.e.c;++c){var i=a[XLS.utils.encode_cell({c:c,r:d})];i&&i.t&&(e=XLS.utils.format_cell(i)),h[b[c]]=e}f.push(h)}return f}}(recline);